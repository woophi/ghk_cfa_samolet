  ...
  useTimeout(
    () =>
      window.location.replace(
        'alfabank://webFeature?type=recommendation&url=https://dfa.alfabank.ru/retail-investor/webview/?channel=df2',
      ),
    5000,
  );
  return (
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          block
          view="primary"
          href="alfabank://webFeature?type=recommendation&url=https://dfa.alfabank.ru/retail-investor/webview/?channel=df2"
        >
          Буду ждать!
        </ButtonMobile>
      </div>
